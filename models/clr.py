...
class CyclicScheduler():
    ...
    def __init__(self, base_lr=0.001, max_lr=0.006, step=1., mode='triangular',
...
if __name__ == '__main__':
    ...
    scheduler = CyclicScheduler(base_lr=0.0005, max_lr=0.005, step=20., mode='triangular2', gamma=1., scale_mode='cycle') ##exp_range ##triangular2


    lrs = np.zeros((num_epoches),np.float32)
    scheduler._reset(iteration = 120)

    for epoch in range(120,num_epoches):
