...
if __name__ == '__main__':
    ...
    m,s = get_iou_vector(gt_batch, (pred_batch * (images_batch > img_threshold) > threshold).astype(np.uint8))
    print('AP = {}, std = {}'.format(m,s))
    print('AP2 = {}'.format(iou_metric_batch(gt_batch, (pred_batch * (images_batch > img_threshold) > threshold).astype(np.uint8))))
